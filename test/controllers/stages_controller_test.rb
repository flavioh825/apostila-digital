...
class StagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post stages_url, params: { stage: { course_id: @stage.course_id, name: @stage.name } }, as: :json
    end
  ...
  test "should update stage" do
    patch stage_url(@stage), params: { stage: { course_id: @stage.course_id, name: @stage.name } }, as: :json
    assert_response 200
  end
